...
if SERVER then
    ...
    ENT.Inf_ChevSounds = {Sound("moonwatcher/stargate/chevron_crystal.wav"), Sound("moonwatcher/stargate/chevron_crystal.wav"), Sound("moonwatcher/stargate/chevron_crystal.wav"), Sound("moonwatcher/stargate/chevron_crystal.wav"), Sound("moonwatcher/stargate/chevron_crystal.wav"), Sound("moonwatcher/stargate/chevron_crystal.wav"), Sound("moonwatcher/stargate/chevron_crystal.wav")}
    ENT.SkinNumber = 6
    ENT.SkinBase = 4
    ...
    if (StarGate and StarGate.CAP_GmodDuplicator) then
        duplicator.RegisterEntityClass("dhd_virgo", StarGate.CAP_GmodDuplicator, "Data")
    end
end

...
if SERVER then
    ...
    function ENT:Initialize()
        ...
        self:CreateWireOutputs("Active", "Naquadah", "Naquadah %", "Countdown", "Energy", "Health")
        self.EntHealth = 100
    ...
    --####### Activate or deactivate @RononDex
    function ENT:Use(p)
    ...
    function ENT:OnTakeDamage(dmg)
        ...
        if self.EntHealth < 1 and self.Exploded == false then
            self.Exploded = true
            self:Bang()
        end
    end

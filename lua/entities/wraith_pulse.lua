...
if SERVER then
    ...
    function ENT:Initialize()
        ...
        self.Damage = 30 + 48 * self.Size --StarGate.CFG:Get("staff","damage",150);
    ...
    function ENT:Think()
        ...
        if ((time - self.Created >= 0.1 or self.InstantEffect) and time - (self.Last or 0) > 0.3) then
            ...
            if (math.abs(dot_prod) < 0.5 and dot_prod ~= 0 and len < 500) then
                ...
                self.Entity:EmitSound(self.Sounds[math.random(1, #self.Sounds)], 75 * (1 - intensity / 2500), math.random(80, 120))

...
if SERVER then
    ...
    --timer function
    local function AutoClose(EntTable)
        local gate, iris
    ...
    function ENT:RecieveIrisCode(code)
        ...
        -- if no code was found, this'll be 0 still
        if self.CodeStatus == 0 and self.donotautoopen then
...
if CLIENT then
    ...
    local function gdopc_menuhook(len)
        ...
        title:SetText("Iris Computer Menu")
        title:SetPos(25, 0)

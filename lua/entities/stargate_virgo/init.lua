...
function ENT:SpawnFunction(p,t)
	...
	local e = ents.Create("stargate_virgo");
...
if (StarGate and StarGate.CAP_GmodDuplicator) then
	duplicator.RegisterEntityClass( "stargate_virgo", StarGate.CAP_GmodDuplicator, "Data" )
end

...
if SERVER then
    ...
    ENT.SguRamps = {"models/boba_fett/ramps/sgu_ramp/sgu_ramp.mdl", "models/boba_fett/ramps/sgu_ramp/sgu_ramp_old.mdl", "models/boba_fett/ramps/sgu_ramp/sgu_ramp_small.mdl", "models/markjaw/sgu_ramp.mdl", "models/iziraider/sguramp/sgu_ramp.mdl"}
    ...
    function ENT:PostEntityPaste(ply, Ent, CreatedEntities)
        ...
        if (IsValid(ply)) then
            ...
            if (ply:GetCount("CAP_anim_ramps") + 1 > PropLimit) then
                ...
                Anim"someString"
                ramp"someString"
                limit", NOTIFY_ERROR, 5); surface.PlaySound( \"buttons/button2.wav\" )"
                self.Entity:Remove()

...
if SERVER then
    ...
    function ENT:Initialize()
        ...
        self.ShipClass = {"sg_vehicle_f302", "puddle_jumper", "sg_vehicle_glider", "sg_vehicle_gate_glider", "sg_vehicle_dart"}
    ...
    function ENT:ButtonPressed(id, ply)
        ...
        elseif (id == 3) then
            ...
            if (e.HangarSpawn) then
                e:HangarSpawn(ply)
            end

            e:SetWire("Health", e:GetNetworkedInt("health"))

            if CPPI and IsValid(ply) and e.CPPISetOwner then
                e:CPPISetOwner(ply)
            end
        ...
        elseif (id == 4) then
            ...
            if self.LockedDoor then
                self.LED:SetColor(Color(0, 255, 0, 255))
            else
                self.LED:SetColor(Color(20, 50, 20, 255))
            end
        elseif (id == 5) then
    ...
    function ENT:PreEntityCopy()
        ...
        if IsValid(self.Door1) then
            dupeInfo.Door1 = self.Door1:EntIndex()
        end
    ...
    function ENT:PostEntityPaste(ply, Ent, CreatedEntities)
        ...
        if dupeInfo.Door1 then
            self.Door1 = CreatedEntities[dupeInfo.Door1]
            self.Door1.Parent = self.Entity
            self.Door1.Factor = 1
        end

        if dupeInfo.Door2 then
            self.Door2 = CreatedEntities[dupeInfo.Door2]
            self.Door2.Parent = self.Entity
            self.Door2.Factor = -1
        end

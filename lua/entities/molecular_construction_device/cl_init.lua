...
function ENT:Draw()
    ...
    if (LocalPlayer():GetEyeTrace().Entity == self.Entity and EyePos():Distance(self.Entity:GetPos()) < 1024) then
        hook.Add("HUDPaint", tostring(self.Entity) .. "MCD", function()
            ...
            -- if (LocalPlayer():GetNWInt('ATA',0) ==0) then
            -- surface.SetFont("AncientsC")
            -- draw.DrawText("MCD", "AncientsC", ScrW() / 2 + 70 + w, ScrH() / 2 + 43 - h - 74, Color(0, 255, 255, 255), 0)
            -- draw.DrawText(self.ProgressMsg, "AncientsC", ScrW() / 2 + 40 + w, ScrH() / 2 + 65 - h - 70, Color(209, 238, 238, 255), 0)
            -- surface.SetFont("AncientsC")
        --else
        ...
        --end
            ...
            --if (LocalPlayer():GetNWInt('ATA',0) ==0) then
                --draw.SimpleText(percent .. "%", "AncientsC", ScrW() / 2 + 40 + w, ScrH() / 2 + 85 - h - 70, Color(209, 238, 238, 255), 0)
            --else
...
function VGUI:Init()
    surface.PlaySound("sg/jumper/jumper_screen_activate.wav")
    ...
    DermaPanel:SetFontInternal("AncientsC")
...
function VGUI_AbortScreen:Init()
    ...
    MenuButtonClose:SetParent(DermaPanel)
    --if (LocalPlayer():GetNWInt('ATA',0) ==0) then
        --MenuButtonClose:SetFont("AncientsC")
    --end
    MenuButtonClose:SetText("Cancel")
    MenuButtonClose:SetPos(200, 40)
    MenuButtonClose:SetSize(160, 45)
    ...
    --if (LocalPlayer():GetNWInt('ATA',0) ==0) then
       --MenuButtonAbort:SetFont("AncientsC")
    --end
    MenuButtonAbort:SetText("Abort Construction")
    MenuButtonAbort:SetPos(10,40)
    MenuButtonAbort:SetSize(160, 45)

...
function TOOL:ControlsPanel(Panel)
    ...
    Panel:AddControl("Label", {
        Text = SGLanguage.GetMessage("stool_sgcscreen_sv")
    })
    ...
    Panel:AddControl("Label", {
        Text = SGLanguage.GetMessage("stool_sgcscreen_cl")
    })
    ...
    for k, SCR in SortedPairs(screens) do
        ...
        panel:AddOption(name, {
            sgc_screen_program = SCR.ID
        })
    end
	...
	Panel:AddControl("PropSelect",
		...
		ConVar="sgc_screen_model",
		Category="",
		Models=models
	});

    Panel:AddControl("Label", {
        Text = SGLanguage.GetMessage("stool_sgcscreen_fulldesc")
    })

    Panel:AddControl("Label", {
        Text = SGLanguage.GetMessage("stool_sgcscreen_controls")
    })
end

...
StarGate.Teleport:Add("gmod_hoverball", function(e, pos, ang, vel, old_pos, old_ang, old_vel, ang_delta)
    if (e.TargetZ) then
...
StarGate.Teleport:Add("gmod_wire_hoverball", function(e, pos, ang, vel, old_pos, old_ang, old_vel, ang_delta)
...
StarGate.Teleport:Add("rpg_missile", function(e, pos, ang, vel, old_pos, old_ang, old_vel, ang_delta)
...
--##### Hoverboard
StarGate.Teleport:Add("modulus_hoverboard", function(e, pos, ang, vel, old_pos, old_ang, old_vel, ang_delta)
    if (e.GetDriver) then
        local p = e:GetDriver()
